...
See also: [Extending Han with Plugin Dependencies](./extending-han-via-plugin-dependencies.md) for a worked, task-focused guide built on Han's own three plugins.
