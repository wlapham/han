...
* `han.coding`: code-writing and execution skills like `/tdd` and `/refactor`
...
add `han.coding@han` on its own if you want just the code-writing skills (`/tdd`, `/refactor`) alongside core.
