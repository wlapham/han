...
- docs(plugin-builder): add rule about token locality to skill-building references (#118) — [@taminomara](https://github.com/taminomara)
- docs(plugin-builder): correct context-injection command permission model (#121) — [@taminomara](https://github.com/taminomara)
